class PvPToken_NPC : public CreatureScript
{
    ...
    {
        pPlayer->ADD_GOSSIP_ITEM(6, "|TInterface/ICONS/INV_Misc_Coin_05:30|t Morphs", GOSSIP_SENDER_MAIN, 0);
        pPlayer->ADD_GOSSIP_ITEM(6, "|TInterface/ICONS/INV_Misc_Coin_05:30|t Titles", GOSSIP_SENDER_MAIN, 1);
        pPlayer->ADD_GOSSIP_ITEM(6, "|TInterface/ICONS/INV_Misc_Coin_05:30|t Mounts", GOSSIP_SENDER_MAIN, 2);
        pPlayer->ADD_GOSSIP_ITEM(6, "|TInterface/ICONS/INV_Misc_Coin_05:30|t Buffs", GOSSIP_SENDER_MAIN, 3);
