uint32 WARRIOR_GLYPH_VENDOR      = 500111;
uint32 PALADIN_GLYPH_VENDOR      = 500068;
uint32 HUNTER_GLYPH_VENDOR       = 500046;
uint32 ROGUE_GLYPH_VENDOR        = 500095;
uint32 PRIEST_GLYPH_VENDOR       = 500113;
uint32 DEATH_KNIGHT_GLYPH_VENDOR = 500026;
uint32 SHAMAN_GLYPH_VENDOR       = 500097;
uint32 MAGE_GLYPH_VENDOR         = 500057;
uint32 WARLOCK_GLYPH_VENDOR      = 500110;
uint32 DRUID_GLYPH_VENDOR        = 500027;
...
public:
	...
	bool OnGossipSelect(Player* player, Creature* creature, uint32 sender, uint32 action)
	{
		...
		if (sender == GOSSIP_SENDER_MAIN)
		{
			switch (action)
			{
			case 1: // Teach me all my class spells, etc.
